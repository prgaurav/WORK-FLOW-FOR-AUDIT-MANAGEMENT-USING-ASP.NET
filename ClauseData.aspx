    ...
    <form id="form1" runat="server" style="text-align: left; font-size: 1.5em; color: white; margin-top: 150px; margin-right: 300px; margin-left: 250px;">
        <div>
            ...
            <div class="padding">
                ...
                <asp:TextBox ID="inputClauseText" runat="server" Style="margin-left: 25px;"></asp:TextBox>&nbsp
            ...
            <br/>
            <div class="padding">
                <asp:Label ID="existingLabel" runat="server" Text="Existing Clauses : "></asp:Label>
