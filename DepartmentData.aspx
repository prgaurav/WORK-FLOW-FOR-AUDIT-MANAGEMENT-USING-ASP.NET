...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="Server">
    ...
    <form id="form1" runat="server" style="text-align:left;font-size:1.5em;color:white;margin-top:150px;margin-right:300px;margin-left:200px;">
        ...
        <div class="padding">
            ...
            <asp:DropDownList ID="CompanyDropDown" runat="server" style="margin-left:25px;"></asp:DropDownList>
        </div>
        <br />
        <div class="padding">
            <asp:Label ID="Label2" runat="server" Text="Enter Department : "></asp:Label>
            <asp:TextBox ID="inputDepartment" runat="server"></asp:TextBox>
            <asp:Button CssClass="btn btn-primary" ID="standardButton" runat="server" Text="Add" OnClick="standardButton_Click" />&nbsp
        </div>
        <br />
        ...
        <br /><br />
        <div class="padding">
            <asp:Label ID="existingLabel" runat="server" Text="Existing Departments : "></asp:Label>
